...
export default async function TetrisDetailPage() {
      ...
      <div className="av-detail">
        ...
        <div>
          <div className="detail-cover">
            <div
              className="cover-bg cover-tetris"
              style={{ position: "absolute", inset: 0 }}
            />
          </div>
          <div className="detail-actions" style={{ marginTop: "18px" }}>
            <Link href="/games/tetris/play">
          ...
          <div className="stat-strip">
            ...
            <div>
              ...
              <div className="v" style={{ fontSize: "10px" }}>
                {game?.category?.toUpperCase() ?? "PUZZLE"}
              </div>
            </div>
          </div>
